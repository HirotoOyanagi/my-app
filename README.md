...
## アプリの使い方
-1.https://my-app-amber-two-94.vercel.app/にアクセスします。
-2.手紙の送りたい相手と、自分の名前を入力し、音声入力をはじめるをクリックします。
-3.手紙を送りたい相手に、自分の素直な思いを伝えます。しっかりと思いを伝えると、その思いをくみ取って手紙の代筆を行ってくれます。（アプリはパソコンで使用してください。スマホからだと音声をうまく対処できない可能性があります。）
-4.写真を保存やテキストを保存をクリックすると、手紙を保存することができます。（手紙の雰囲気をそのまま保存できる写真で保存がおすすめです。
